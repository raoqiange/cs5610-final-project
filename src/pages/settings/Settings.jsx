        ...
        <div className="settings">
            <div className="settingsWrapper">
                ...
                <form className="settingsForm">
                    ...
                    <input type="text" value={currentUser && currentUser.username} name="name"/>
                    <label>Password</label>
                    <input type="password" defaultValue={currentUser && currentUser.password} name="password"
                           id="new-password"/>

                    {currentUser && currentUser.role === 'FAN' ?
                        <>
                            <label>Your favorite aime genre</label>
                            <input id="new-fav-genre" type="text"
                    ...
                    {currentUser && currentUser.role === 'ADMIN' ?
                        <>
                            ...
                            <input id="new-email" type="text" defaultValue={currentUser && currentUser.email}/> </> :
                        <></>
                    }
